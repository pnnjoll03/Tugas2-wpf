                            ...
                            <td class="border border-gray-300 py-2 px-3">
                                <div class="flex flex-col space-y-1">
                                    <a href="{{ route('attendances.show', $attendance->id) }}" 
                                       class="bg-blue-500 hover:bg-blue-600 text-white text-center py-1 px-2 rounded text-sm transition duration-200 flex items-center justify-center gap-1">
                                        <i class="fas fa-eye text-xs"></i>
                                        <span>Detail</span>
                                    </a>
                                    <a href="{{ route('attendances.edit', $attendance->id) }}" 
                                       class="bg-yellow-500 hover:bg-yellow-600 text-white text-center py-1 px-2 rounded text-sm transition duration-200 flex items-center justify-center gap-1">
                                    ...
                                    <form action="{{ route('attendances.destroy', $attendance->id) }}" method="POST" class="m-0">
                                        ...
                                        @method('DELETE')
                                        <button type="submit" 
                                                class="bg-red-500 hover:bg-red-600 text-white w-full text-center py-1 px-2 rounded text-sm transition duration-200 flex items-center justify-center gap-1"
